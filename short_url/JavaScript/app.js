...
import {ShortLinks} from "./classLinks.js";
    ...
    async function inputHandle(){
        const res = await fetch("https://api-ssl.bitly.com/v4/shorten", {
            ...
            headers: { 
                ...
                'Authorization': 'Bearer 3b519f065dc41b3efe0587032bf2c5a8ff2d5d76'
            }
        });
...
document.querySelector(".short-links").addEventListener("click", (e) => {
